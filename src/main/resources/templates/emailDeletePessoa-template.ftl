                ...
                <tr>
                    <td align="center" valign="top" bgcolor="#d3be6c"
                        ...
                        <div style="font-size: 48px; color:#010326;">
                            <b>Notificação de Remoção de Dados</b>
                            <br>
                        </div>

                        <div style="font-size: 24px; color: #010326;">
                            <b>Olá, ${nome}</b>
                            <b>Informamos que todos os seus dados foram apagados do nosso sistema. Estaremos lhe esperando caso queira participar novamente do nosso time.</b>
